...
* Download the Querqy .jar file that matches your Solr version from the table
  ...
  +================+==========================================================================================================================================================+
  | 9.0.0         | :download:`5.4.lucene900.0<https://repo1.maven.org/maven2/org/querqy/querqy-solr/5.4.lucene900.0/querqy-solr-5.4.lucene900.0-jar-with-dependencies.jar>` |
  +----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
  | 8.11.x         | :download:`5.4.lucene810.0<https://repo1.maven.org/maven2/org/querqy/querqy-solr/5.4.lucene810.0/querqy-solr-5.4.lucene810.0-jar-with-dependencies.jar>` |
  +----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
