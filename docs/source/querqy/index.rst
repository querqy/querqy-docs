...
* Download the Querqy .jar file that matches your Solr version from the table
  ...
  +================+==========================================================================================================================================================+
  | 8.11.x         | :download:`5.3.lucene810.2<https://repo1.maven.org/maven2/org/querqy/querqy-solr/5.3.lucene810.2/querqy-solr-5.3.lucene810.2-jar-with-dependencies.jar>` |
  +----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
