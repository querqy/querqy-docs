...
.. tabs::
      ...
      * Run OpenSearch's plugin install script:
      ...
      .. raw:: html
        ...
        <select class="os-url-select"
          ...
          <option value="https://repo1.maven.org/maven2/org/querqy/opensearch-querqy/1.1.os3.4.0/opensearch-querqy-1.1.os3.4.0.zip">OpenSearch 3.4.0</option>
      ...
      .. rst-class:: opensearch-version

      .. code-block:: shell

        ./bin/opensearch-plugin install \
          "https://repo1.maven.org/maven2/org/querqy/opensearch-querqy/1.1.os3.4.0/opensearch-querqy-1.1.os3.4.0.zip"
   ...
   .. group-tab:: Solr
      ...
      * Download the Querqy .jar file that matches your Solr version from the table
        ...
        +================+==========================================================================================================================================================+
        | 9.8.0          | :download:`5.9.lucene980.0<https://repo1.maven.org/maven2/org/querqy/querqy-solr/5.9.lucene980.0/querqy-solr-5.9.lucene980.0-jar-with-dependencies.jar>` |
        +----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 9.6.1          | :download:`5.8.lucene961.1<https://repo1.maven.org/maven2/org/querqy/querqy-solr/5.8.lucene961.1/querqy-solr-5.8.lucene961.1-jar-with-dependencies.jar>` |
        +----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 9.4.2          | :download:`5.7.lucene942.0<https://repo1.maven.org/maven2/org/querqy/querqy-solr/5.7.lucene942.0/querqy-solr-5.7.lucene942.0-jar-with-dependencies.jar>` |
        +----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
